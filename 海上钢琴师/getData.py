...
def save_to_txt():
    for i in range(20,101):
    	try:
	        print("开始保存第%d页" % i)
	        url = 'http://m.maoyan.com/mmdb/comments/movie/1292.json?_v_=yes&offset=' + str(i)

	        html = get_one_page(url)
	        for item in parse_one_page(html):
	            with open('海上钢琴师.txt','a',encoding='utf-8') as f:
...
if __name__ == '__main__':
    save_to_txt()
    delete_repeat(r'海上钢琴师_old.txt',r'海上钢琴师_new.txt')