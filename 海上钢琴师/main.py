...
f = open('海上钢琴师.txt',encoding='utf-8')
...
geo = Geo("《海上钢琴师》粉丝人群地理位置","数据来源：练习Python",**style.init_style)
...
#导入背景图
backgroud_Image = plt.imread('海上钢琴师.jpg') 
